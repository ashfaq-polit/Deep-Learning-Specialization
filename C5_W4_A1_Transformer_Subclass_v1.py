...
class EncoderLayer(tf.keras.layers.Layer):
    ...
    def call(self, x, training, mask):
        ...
        out1 = self.layernorm1(tf.math.add(x,attn_output))   # (batch_size, input_seq_len, fully_connected_dim)
        ...
        encoder_layer_out = self.layernorm2(tf.math.add(out1,ffn_output))  # (batch_size, input_seq_len, fully_connected_dim)
        # END CODE HERE
...
class DecoderLayer(tf.keras.layers.Layer):
    ...
    def call(self, x, enc_output, training, look_ahead_mask, padding_mask):
        ...
        Q1 = self.layernorm1(tf.math.add(x,mult_attn_out1))
        ...
        mult_attn_out2 = self.layernorm2(tf.math.add(Q1,mult_attn_out2))   # (batch_size, target_seq_len, fully_connected_dim)
        ...
        out3 = self.layernorm3(tf.math.add(ffn_output,mult_attn_out2))  # (batch_size, target_seq_len, fully_connected_dim)
        # END CODE HERE
...
class Transformer(tf.keras.Model):
    ...
    def call(self, input_sentence, output_sentence, training, enc_padding_mask, look_ahead_mask, dec_padding_mask):
        ...
        dec_output, attention_weights = self.decoder(input_sentence, enc_output, training, look_ahead_mask, dec_padding_mask)
